...
from unet import UNet  # Assuming you have a ConvLSTM class in a network.py file
from dataset import VideoDataset  # Assuming you have a VideoDataset class in a dataset.py file
import os 
        ...
        with torch.no_grad():
            ...
            for batch_idx, (frames, target) in enumerate(val_loader):
                if batch_idx == random_batch_index:
                    ...
                    reconstructed = model(reshaped_frames)
