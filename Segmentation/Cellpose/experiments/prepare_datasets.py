...
if __name__ == "__main__":
    ...
    # download_and_unzip("https://datasets.simula.no/downloads/cellular-experiments.zip", args.input_path), "C:\Users\oriana\Desktop\Projects\Autophagy_cells\Segmentation\Cellpose\cellular-experiments\masks"
