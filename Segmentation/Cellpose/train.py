...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_type", default="cyto2torch_3", type=str, help="Pretrained model")
    parser.add_argument('--experiments_dir', type=str, default="./experiments_train", help='Directory to output images and evaluation')
    parser.add_argument('--experiment_name', default="experiment", type=str, help='Path to the testing directory')
    parser.add_argument('--force', action='store_true', default=False, help='Force of results directory')

    parser.add_argument('--n_epochs', type=int, default=301, help='Number of epochs')
