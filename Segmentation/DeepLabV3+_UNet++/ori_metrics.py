...
# Usage
folder1 = 'data/test/cropped_masks_resized'  # Path to the folder containing the ground truth masks
folder2 = 'data/test/deeplab_segm'  # Path to the folder containing the predicted masks
